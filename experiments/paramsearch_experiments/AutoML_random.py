...
def autoML(seasonNumber, features, iterations, time, processes, refit):
    ...
    f = join(experiments.paths.modeldatadir + join(str(seasonNumber), feat + "_AutoML_{}s".format(time)))
    if refit:
        f = f + "_refit"
