...
def WGStoCHy(lat, lng):
	...
	# Process Y
	y = (600072.37 + 211455.93 * lng_aux - 10938.51 * lng_aux * lat_aux - 0.36 * lng_aux * lat_aux ** 2 - 44.54 *
	     lng_aux ** 3)
...
def WGStoCHx(lat, lng):
	...
	# Process X
	x = (200147.07 + 308807.95 * lat_aux + 3745.25 * lng_aux ** 2 + 76.63 * lat_aux ** 2 - 194.56 * lng_aux ** 2 *
	     lat_aux + 119.79 * lat_aux ** 3)
...
def CHtoWGSlat(y, x):
	...
	# Process lat
	lat = (16.9023892 + 3.238272 * x_aux - 0.270978 * y_aux ** 2 - 0.002528 * x_aux ** 2 - 0.0447 * y_aux ** 2 * x_aux -
	       0.0140 * x_aux ** 3)
